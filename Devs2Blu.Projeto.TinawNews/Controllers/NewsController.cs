...
namespace Devs2Blu.Projeto.TinawNews.Controllers
{
    public class NewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,CategoryId")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,CategoryId")] News news)
        {
            if (id != news.Id)
            {
                return NotFound();
